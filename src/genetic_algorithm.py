import random
from src.util.ga_util import bitstr2float
import numpy as np
...
class genetic_algorithm:
    ...
    def __init__(self, population_size, individual_size, individual_max, individual_min, mutate_probability, crossover_probability, fit_func, is_min):
        ...
        self.individual_size = individual_size # Size of each individual
        self.individual_max = individual_max # Max value of each gene
        self.individual_min = individual_min # Min value of each gene
        self.mutate_probability = mutate_probability # Probability of mutation
        self.crossover_probability = crossover_probability # Probability of crossover
        self.fit_func = fit_func # Fitness function
        self.is_min = is_min # True if minimization problem, False if maximization problem
    ...
    def crossover(self, parents, children_size):
        # children are generated if value generated less than crossover rate. We employ single point crossover
        children = []
